...
use smithay::{
    ...
    desktop::{Kind as SurfaceKind, PopupKind, PopupManager, Space, Window, LayerSurface, layer_map_for_output},
    reexports::{
    ...
    wayland::{
        ...
        shell::{
            ...
            wlr_layer::{LayerShellState, LayerShellRequest, LayerSurfaceAttributes},
            xdg::{
