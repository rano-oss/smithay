...
#[derive(Debug)]
pub struct TextInputManagerStateV3 {
    global: GlobalId,
}

impl TextInputManagerStateV3 {
...
impl<D> GlobalDispatch<ZwpTextInputManagerV3, (), D> for TextInputManagerStateV3
where
    D: GlobalDispatch<ZwpTextInputManagerV3, ()>,
    D: Dispatch<ZwpTextInputManagerV3, ()>,
    D: Dispatch<ZwpTextInputV3, TextInputUserData>,
...
impl<D> Dispatch<ZwpTextInputManagerV3, (), D> for TextInputManagerStateV3
where
    D: Dispatch<ZwpTextInputManagerV3, ()>,
    D: Dispatch<ZwpTextInputV3, TextInputUserData>,
    D: SeatHandler,
...
macro_rules! delegate_text_input_manager {
    ($(@<$( $lt:tt $( : $clt:tt $(+ $dlt:tt )* )? ),+>)? $ty: ty) => {
        ...
        ] => $crate::wayland::text_input::v3::TextInputManagerStateV3);
        ...
        $crate::reexports::wayland_server::delegate_dispatch!($(@< $( $lt $( : $clt $(+ $dlt )* )? ),+ >)? $ty: [
            ...
            $crate::wayland::text_input::v3::TextInputUserData
        ] => $crate::wayland::text_input::v3::TextInputManagerStateV3);
    };
}
