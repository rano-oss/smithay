...
#[derive(Debug)]
pub struct InputMethodManagerStateV2 {
    global: GlobalId,
}

impl InputMethodManagerStateV2 {
...
impl<D> GlobalDispatch<ZwpInputMethodManagerV2, InputMethodManagerGlobalData, D> for InputMethodManagerStateV2
where
    D: GlobalDispatch<ZwpInputMethodManagerV2, InputMethodManagerGlobalData>,
    D: Dispatch<ZwpInputMethodManagerV2, ()>,
    D: Dispatch<ZwpInputMethodV2, InputMethodUserData<D>>,
...
impl<D> Dispatch<ZwpInputMethodManagerV2, (), D> for InputMethodManagerStateV2
where
    D: Dispatch<ZwpInputMethodManagerV2, ()>,
    D: Dispatch<ZwpInputMethodV2, InputMethodUserData<D>>,
...
macro_rules! delegate_input_method_manager {
    ($(@<$( $lt:tt $( : $clt:tt $(+ $dlt:tt )* )? ),+>)? $ty: ty) => {
        $crate::reexports::wayland_server::delegate_global_dispatch!($(@< $( $lt $( : $clt $(+ $dlt )* )? ),+ >)? $ty: [
            ...
            $crate::wayland::input_method::v2::InputMethodManagerGlobalData
        ] => $crate::wayland::input_method::v2::InputMethodManagerStateV2);
        ...
        $crate::reexports::wayland_server::delegate_dispatch!($(@< $( $lt $( : $clt $(+ $dlt )* )? ),+ >)? $ty: [
            ...
            $crate::wayland::input_method::v2::InputMethodUserData<Self>
        ] => $crate::wayland::input_method::v2::InputMethodManagerStateV2);
        $crate::reexports::wayland_server::delegate_dispatch!($(@< $( $lt $( : $clt $(+ $dlt )* )? ),+ >)? $ty: [
            ...
            $crate::wayland::input_method::v2::InputMethodKeyboardUserData<Self>
        ] => $crate::wayland::input_method::v2::InputMethodManagerStateV2);
        $crate::reexports::wayland_server::delegate_dispatch!($(@< $( $lt $( : $clt $(+ $dlt )* )? ),+ >)? $ty: [
            $crate::reexports::wayland_protocols_misc::zwp_input_method_v2::server::zwp_input_popup_surface_v2::ZwpInputPopupSurfaceV2:
            $crate::wayland::input_method::v2::InputMethodPopupSurfaceUserData
        ] => $crate::wayland::input_method::v2::InputMethodManagerStateV2);
    };
}
